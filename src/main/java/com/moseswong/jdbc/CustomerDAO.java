...
import com.moseswong.jdbc.util.DataAccessObject;
...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    private static final String Get_One = "SELECT customer_id, first_name, last_name, " +
            "email, phone, address, city, state, zipcode FROM " +
    ...
    private static final String GET_ALL_LMT = "SELECT customer_id, first_name, last_name, " +
            "email, phone, address, city, state, zipcode FROM " +
            "customer ORDER BY last_name, first_name LIMIT ?";

    private static final String GET_ALL_PAGED = "SELECT customer_id, first_name, last_name, " +
            "email, phone, address, city, state, zipcode FROM " +
            "customer ORDER BY last_name, first_name LIMIT ?  OFFSET ?";
